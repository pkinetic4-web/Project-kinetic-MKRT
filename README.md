...
​Fractal Geometry: Uses a nested Gyroid TPMS lattice for multiscale damping, from high-frequency vibrations to catastrophic impacts.
​🛠️ Applications
​Maritime: Self-healing, "slick" hull armor that restores the environment via mineral accretion.
